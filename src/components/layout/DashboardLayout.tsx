    ...
    if (role === "farmer" || role === "user" || role === "admin" || role === "owner" || true) {
      return [
        ...
        // ───────── BUSINESS ─────────
        {
          ...
          section: "Business",
          children: [
            { name: "Overview", href: "/financials?tab=overview" },
            { name: "Income & Revenue", href: "/financials?tab=income" },
            { name: "Expenses & Costs", href: "/financials?tab=expenses" },
            { name: "Farm Valuation", href: "/financials?tab=valuation" },
          ],
        },
        {
          name: "Marketplace",
