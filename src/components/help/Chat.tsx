     ...
     <div className="bg-white rounded-lg shadow-md mt-4 p-6">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start">
          <svg className="w-6 h-6 mr-4 mt-1 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex items-start">
          <svg className="w-6 h-6 mr-4 mt-1 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex items-start">
          <svg className="w-6 h-6 mr-4 mt-1 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex items-start">
          <svg className="w-6 h-6 mr-4 mt-1 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="mt-8 pt-8 border-t border-gray-200 text-center">
        ...
        <Link href="https://famtechnologia.com" className="px-8 py-3 bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg transition-colors duration-200">
