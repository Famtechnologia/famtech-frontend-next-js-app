...
const DayCell: React.FC<{ day: number; tasks: Task[]; onClick: () => void }> = ({ day, tasks, onClick }) => (
    <div
...
const DayTasksModal: React.FC<{
    ...
    onClose: () => void;
    onTaskUpdate: () => void;
}> = ({ selectedDay, onClose, onTaskUpdate }) => {
    if (!selectedDay) return null;

    const formattedDate = new Date(selectedDay.dateString).toLocaleDateString('en-US', {
        weekday: 'long',
        year: 'numeric',
        month: 'long',
        day: 'numeric'
...
const CalendarView: React.FC = () => {
    ...
    const [selectedDayTasks, setSelectedDayTasks] = useState<SelectedDay | null>(null);
