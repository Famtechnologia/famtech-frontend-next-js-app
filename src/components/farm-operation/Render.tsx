...
// Define the precise type for form values (excluding nested objects)
...
    name: string;
    type?: string;
    value: FormValue; // Previously fixed from 'any'
    placeholder?: string;
...
            <InputField label="Brand" name="toolData.brand" value={toolData.brand} onChange={handleChange} />
            {/* FIX: Corrected syntax error on the name prop for Condition */}
...
                            <InputField 
                                ...
                                name={key} 
                                type="number" 
                                value={data[key as 'n' | 'p' | 'k'] as FormValue} 
                                onChange={handleChange} 
                                placeholder="e.g., 10" 
                            />
                        ))}
