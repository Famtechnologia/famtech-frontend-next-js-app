...
export default function WelcomeHeader() {
  ...
  return (
    <div className="mb-4 sm:mb-6">
      <div
        className={`relative overflow-hidden rounded-lg sm:rounded-xl bg-gradient-to-br ${currentData.gradient} p-4 sm:p-6 lg:p-8 text-white shadow-xl transition-all duration-500 ease-in-out`}
      >
        {/* Background Pattern */}
        ...
        <div className="absolute top-3 sm:top-4 right-4 sm:right-16">
          <div
            className={`h-1 w-8 sm:w-12 bg-white/30 rounded-full overflow-hidden ${isAutoPlaying ? "block" : "hidden"}`}
          >
            <div
