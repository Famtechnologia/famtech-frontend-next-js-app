...
export default function ModernFarmRegistration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/update-farm-profile`, {
        method: 'PATCH',
        headers: {
  ...
  return (
    <div className="min-h-screen bg-none py-12 px-0 md:px-4">
      ...
      <h1 className='text-green-600 flex justify-center text-center items-center mx-auto text-3xl font-bold mb-12'>Update Farm Profile</h1>
