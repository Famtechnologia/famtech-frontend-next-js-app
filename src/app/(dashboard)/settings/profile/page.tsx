...
const Settings: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-8 space-y-8 bg-slate-50/50 dark:bg-[#0d1117] min-h-screen">
      {/* HEADER BANNER */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white dark:bg-[#161b22] rounded-2xl shadow-sm border border-slate-100 dark:border-[#30363d] overflow-hidden">
            <div className="p-6 border-b border-slate-100 dark:border-[#30363d] flex items-center justify-between">
              <div>
                <h2 className="text-lg font-bold text-slate-800 dark:text-[#e6edf3]">Account Details</h2>
                <p className="text-xs text-slate-400 dark:text-[#8b949e] font-medium">Manage your sign-in details</p>
              </div>
            ...
            <div className="p-6 space-y-5">
              <div className="flex items-start gap-4">
                <div className="p-2.5 bg-slate-50 dark:bg-[#21262d] text-slate-500 dark:text-[#8b949e] rounded-xl border border-slate-100 dark:border-[#30363d] shrink-0">
                  <Mail className="h-5 w-5" />
                </div>
                <div className="space-y-0.5">
                  <p className="text-xs font-bold text-slate-400 dark:text-[#8b949e] uppercase tracking-wider">Email Address</p>
                  <p className="text-sm font-semibold text-slate-700 dark:text-[#e6edf3] break-all">{userEmail}</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-2.5 bg-slate-50 dark:bg-[#21262d] text-slate-500 dark:text-[#8b949e] rounded-xl border border-slate-100 dark:border-[#30363d] shrink-0">
                ...
                <div className="space-y-0.5">
                  <p className="text-xs font-bold text-slate-400 dark:text-[#8b949e] uppercase tracking-wider">Phone Number</p>
                  <p className="text-sm font-semibold text-slate-700 dark:text-[#e6edf3]">{phoneNumber}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-[#161b22] rounded-2xl shadow-sm border border-slate-100 dark:border-[#30363d] p-6 space-y-6">
            <div>
              <h2 className="text-lg font-bold text-slate-800 dark:text-[#e6edf3]">System Preferences</h2>
              <p className="text-xs text-slate-400 dark:text-[#8b949e] font-medium">Regional & interface values</p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-slate-50/50 dark:bg-[#21262d] rounded-xl border border-slate-100 dark:border-[#30363d] space-y-1">
                ...
                <p className="text-sm font-bold text-slate-700 dark:text-[#e6edf3]">{currency}</p>
              </div>
              <div className="p-4 bg-slate-50/50 dark:bg-[#21262d] rounded-xl border border-slate-100 dark:border-[#30363d] space-y-1">
                <div className="flex items-center gap-1.5 text-slate-400 dark:text-[#8b949e]">
                ...
                <p className="text-sm font-bold text-slate-700 dark:text-[#e6edf3] uppercase">{language}</p>
              </div>
              <div className="p-4 bg-slate-50/50 dark:bg-[#21262d] rounded-xl border border-slate-100 dark:border-[#30363d] col-span-2 space-y-1">
                <div className="flex items-center gap-1.5 text-slate-400 dark:text-[#8b949e]">
                  <Clock className="h-4 w-4" />
                  <span className="text-[10px] font-bold uppercase tracking-wide">Timezone</span>
                </div>
                <p className="text-sm font-bold text-slate-700 dark:text-[#e6edf3]">{timezone}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-[#161b22] rounded-2xl shadow-sm border border-slate-100 dark:border-[#30363d] p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-bold text-slate-800 dark:text-[#e6edf3]">Operational Profile</h2>
                <p className="text-xs text-slate-400 dark:text-[#8b949e] font-medium">Farm activities and crop layouts</p>
              </div>
              <Link href="/settings/edit-farm-profile" passHref>
                <button className="px-3 py-1.5 text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-100 hover:bg-emerald-100 rounded-lg transition duration-150">
                  Update
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-emerald-50/30 border border-emerald-100/50 rounded-2xl flex items-center gap-4">
                ...
                <div className="space-y-0.5">
                  <p className="text-xs font-bold text-slate-400 dark:text-[#8b949e] uppercase tracking-wider">Farm Type</p>
                  <p className="text-sm font-bold text-slate-800 dark:text-[#e6edf3] capitalize">{farmType}</p>
                </div>
              </div>
              ...
              <div className="p-4 bg-blue-50/30 border border-blue-100/50 rounded-2xl flex items-center gap-4">
                ...
                <div className="space-y-0.5">
                  <p className="text-xs font-bold text-slate-400 dark:text-[#8b949e] uppercase tracking-wider">Farm Size</p>
                  <p className="text-sm font-bold text-slate-800 dark:text-[#e6edf3]">{farmSizeDisplay}</p>
                </div>
              </div>
              ...
              <div className="p-4 bg-amber-50/30 border border-amber-100/50 rounded-2xl flex items-center gap-4">
                ...
                <div className="space-y-0.5">
                  <p className="text-xs font-bold text-slate-400 dark:text-[#8b949e] uppercase tracking-wider">Established</p>
                  <p className="text-sm font-bold text-slate-800 dark:text-[#e6edf3]">{establishedYear || "N/A"}</p>
                </div>
              </div>
            </div>

            {/* ADITIONAL OPERATIONAL DETAILS */}
            <div className="space-y-5 pt-4 border-t border-slate-100 dark:border-[#30363d]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-slate-400">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider dark:text-[#8b949e]">Location & Coordinates</span>
                  </div>
                  <div className="p-4 bg-slate-50 dark:bg-[#21262d] rounded-2xl border border-slate-100 dark:border-[#30363d] space-y-1.5">
                    <p className="text-sm font-semibold text-slate-700 dark:text-[#e6edf3]">{farmLocationDisplay}</p>
                    <p className="text-xs text-slate-400 dark:text-[#8b949e] font-medium">{fullAddress}</p>
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-[#21262d] rounded-2xl border border-slate-100 dark:border-[#30363d] h-[88px] flex flex-col justify-center">
                    <p className="text-sm font-bold text-slate-700 dark:text-[#e6edf3] capitalize">{seasonalPattern.replace("-", " ")}</p>
                    <p className="text-xs text-slate-400 dark:text-[#8b949e] font-medium">Optimal operation schedule set by admin</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                ...
                {/* Farming Methods */}
                <div className="space-y-2">
                  <p className="text-xs font-bold text-slate-400 dark:text-[#8b949e] uppercase tracking-wider">Farming Methods</p>
                ...
                {/* Primary Crops */}
                <div className="space-y-2">
                  <p className="text-xs font-bold text-slate-400 dark:text-[#8b949e] uppercase tracking-wider">Primary Crops</p>
